...
# See notes for individual actions
...
# 5. Using the data above, creates a 2nd, independent tidy data set with the average of each variable for each activity and each subject.
...
write.table(result, "data_set_for_submission.txt")